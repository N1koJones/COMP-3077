<?php
// Set the page title for the Romance Manga page
$pageTitle = "Romance Manga";
...
// Fetch romance manga from the database
$query = $pdo->prepare("
    SELECT b.*
    FROM books b
    INNER JOIN (
...
"); // Query to fetch the first volume of each Romance manga series
$query->execute(['Romance']); // Execute the query with the category 'Romance'
...
<main>
    ...
    <!-- List of books in the Romance category -->
    <ul class="book-list">
