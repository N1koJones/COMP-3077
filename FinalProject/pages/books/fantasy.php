<?php
// Set the page title for the Fantasy Manga page
$pageTitle = "Fantasy Manga";
...
// Fetch fantasy manga from the database
$query = $pdo->prepare("
    SELECT b.*
    FROM books b
    INNER JOIN (
...
"); // Query to fetch the first volume of each Fantasy manga series
$query->execute(['Fantasy']); // Execute the query with the category 'Fantasy'
...
<main>
    ...
    <!-- List of books in the Fantasy category -->
    <ul class="book-list">
