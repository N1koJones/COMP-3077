<?php
// Set the page title for the Shonen Manga page
$pageTitle = "Shonen Manga";
...
// Fetch shonen manga from the database
$query = $pdo->prepare("
    SELECT b.*
    FROM books b
    INNER JOIN (
...
"); // Query to fetch the first volume of each Shonen manga series
$query->execute(['Shonen']); // Execute the query with the category 'Shonen'
...
<main>
    ...
    <!-- List of books in the Shonen category -->
    <ul class="book-list">
