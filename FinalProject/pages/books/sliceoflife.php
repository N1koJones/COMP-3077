<?php
// Set the page title for the Slice of Life Manga page
$pageTitle = "Slice of Life Manga";
...
// Fetch slice of life manga from the database
$query = $pdo->prepare("
    SELECT b.*
    FROM books b
    INNER JOIN (
...
"); // Query to fetch the first volume of each Slice of Life manga series
$query->execute(['Slice of Life']); // Execute the query with the category 'Slice of Life'
...
<main>
    ...
    <!-- Page heading -->
    <h2>Slice of Life Manga</h2>
    
    <!-- List of books in the Slice of Life category -->
    <ul class="book-list">
